...
```bash
git remote add encore encore://image-annotation-app-y8zi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/image-annotation-app-y8zi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/image-annotation-app-y8zi/settings/integrations/github)
